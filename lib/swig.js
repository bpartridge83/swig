...
function createRenderFunc(code) {
  ...
  return new Function('_context', '_parents', '_filters', '_', '_ext', '_allowCircular', [
...
function createTemplate(data, id) {
  ...
  if (code !== false) {
    ...
    render = function (_context, _parents, _filters, _, _ext, _allowCircular) {
      template.tokens = tokens;
      code = parser.compile.call(template, '', _context);
      var fn = createRenderFunc(code);
      return fn.call(this, _context, _parents, _filters, _, _ext, _allowCircular);
    };
  }

  template.render = function (context, parents) {
    if (_config.allowErrors) {
      return render.call(this, context, parents, _config.filters, _, _config.extensions, _config.allowCircular);
    }
    try {
      return render.call(this, context, parents, _config.filters, _, _config.extensions, _config.allowCircular);
    } catch (e) {
